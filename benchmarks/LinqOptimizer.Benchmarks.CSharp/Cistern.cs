...
namespace LinqOptimizer.Benchmarks.CSharp
{
    public partial class SequentialBenchmarks
    {
        ...
        */
        ...
        |------------------------------ |----- |-------------------:|------------------:|------------------:|---------:|--------:|-------------:|------:|------:|-------------:|
        | 'Pythagorean Triples Cistern' |    0 |           582.0 ns |          3.611 ns |          3.378 ns |     1.77 |    0.02 |       0.2508 |     - |     - |        792 B |
        |    'Pythagorean Triples Linq' |    0 |           328.5 ns |          3.229 ns |          2.863 ns |     1.00 |    0.00 |       0.1574 |     - |     - |        496 B |
        |     'Pythagorean Triples Opt' |    0 |       354,655.9 ns |      2,922.388 ns |      2,733.604 ns | 1,079.29 |   11.53 |      30.7617 |     - |     - |      98062 B |
        |                               |      |                    |                   |                   |          |         |              |       |       |              |
        | 'Pythagorean Triples Cistern' |   10 |         8,634.1 ns |         71.339 ns |         66.730 ns |     0.81 |    0.01 |       3.5706 |     - |     - |      11280 B |
        |    'Pythagorean Triples Linq' |   10 |        10,660.5 ns |         79.319 ns |         70.314 ns |     1.00 |    0.00 |       3.6316 |     - |     - |      11456 B |
        |     'Pythagorean Triples Opt' |   10 |       352,958.6 ns |      1,962.591 ns |      1,739.786 ns |    33.11 |    0.29 |      30.7617 |     - |     - |      98070 B |
        |                               |      |                    |                   |                   |          |         |              |       |       |              |
        | 'Pythagorean Triples Cistern' |  100 |     3,170,986.0 ns |     23,760.764 ns |     22,225.833 ns |     0.65 |    0.01 |    1835.9375 |     - |     - |    5781240 B |
        |    'Pythagorean Triples Linq' |  100 |     4,871,139.9 ns |     28,270.715 ns |     26,444.445 ns |     1.00 |    0.00 |    1843.7500 |     - |     - |    5822096 B |
        |     'Pythagorean Triples Opt' |  100 |       571,383.5 ns |      3,913.331 ns |      3,660.532 ns |     0.12 |    0.00 |      30.2734 |     - |     - |      98070 B |
        |                               |      |                    |                   |                   |          |         |              |       |       |              |
        | 'Pythagorean Triples Cistern' | 1000 | 2,781,007,992.9 ns |  9,857,092.030 ns |  8,738,055.338 ns |     0.63 |    0.00 | 1709000.0000 |     - |     - | 5377404840 B |
        |    'Pythagorean Triples Linq' | 1000 | 4,384,790,307.1 ns | 16,578,918.412 ns | 14,696,779.342 ns |     1.00 |    0.00 | 1710000.0000 |     - |     - | 5381416496 B |
        |     'Pythagorean Triples Opt' | 1000 |   176,375,866.7 ns |  2,141,939.770 ns |  2,003,571.790 ns |     0.04 |    0.00 |            - |     - |     - |     100344 B |
        */
